...
decoded=''.join(c if c not in guess else guess[c] for c in puzzle) #this is a list comprehension that substitutes the character in the string with the one in the guess dictionary
