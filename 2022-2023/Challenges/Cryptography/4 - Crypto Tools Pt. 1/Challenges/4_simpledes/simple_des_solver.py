...
def rule9b1(b):
    #get indexed
    row = int(b[0]) #first bit
    col = int(b[1:], 2) #b[1:] is the rest of the bits and converted into int from binary

    matrix = [['100','000','110','101','111','001','011','010'],
        ['101','011','000','111','110','010','001','100']]

    return matrix[row][col] #return the value of the matrix
...
def xor(a, b):
    ...
    return f"{res:08b}" #we need to convert the text into bits and f is used to convert the bits into text
