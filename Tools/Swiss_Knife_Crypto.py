...
#Pacchetti utili PIP (si può installare con pip, nel caso mettere anche sudo davanti)
#pip install pycryptodome (per la cifratura)
#pip install crypto (uguale a sopra ma con meno funzioni)
#pip install pwntools (per la gestione dei processi e utile per varie cose)
#pip install flask (per la creazione di server web)
#pip install requests (per fare richieste http)
#pip install numpy (numeri random)
